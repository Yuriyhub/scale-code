...
def on_message(client, userdata, message):
    if message.topic == "/esp8266/dhtreadings":
        ...
        c.execute("""INSERT INTO dhtreadings (name, weight,
            currentdate) VALUES((?), (?), datetime('now','localtime'))""",
             ('Yuriy', dhtreadings_json['weight']) )
...
def getinfo():
   ...
   c=conn.cursor()
   c.execute("select currentdate, weight from dhtreadings")
